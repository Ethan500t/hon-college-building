...
function App() {
  let pageName: string = "overview";
  const handlePageChange = (pageName: string) => {
    setCurrentPage(<Page pageName={pageName}/>)
  }
  const [currentPage, setCurrentPage] = useState(<Page pageName={pageName}/>
      ...
      <aside id="default-sidebar" className="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
        ...
        <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
            <ul className="space-y-2">
              <li>
                  <button onClick={handlePageChange("overview")}> Overview </button>
              ...
              <li>
                  <a href="#" className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                    ...
                    <span className="flex-1 ml-3 whitespace-nowrap">Floor 1</span>
