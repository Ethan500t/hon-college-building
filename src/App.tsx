...
function App() {
  ...
  const navButtonClasses = "text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
  ...
  return (
    <>
      ...
      <nav className=" border-gray-200 px-2 sm:px-4 py-2.5 rounded bg-green-800 dark:bg-gray-900">
        <div className="container flex flex-wrap items-center justify-between mx-auto ">
          <a href="https://flowbite.com/" className="flex items-center">
              <img src="https://flowbite.com/docs/images/logo.svg" className="h-6 mr-3 sm:h-9" alt="Flowbite Logo" />
              <span className="self-center text-xl font-semibold whitespace-nowrap text-white dark:text-black">Honors College Building</span>
          </a>
          ...
          <div className="hidden w-full md:block md:w-auto" id="navbar-default">
            ...
            <button onClick={() => setCurrentPage("floorOne")} className={navButtonClasses}> Floors </button>
              <li>
      ...
      <Page pageName={"overview"} className={""}/>
